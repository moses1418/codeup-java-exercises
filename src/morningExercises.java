...
//
//            if(colors.startsWith(userInput)) {
//                System.out.println("My fave color: " + userInput + " is the first one!");
//            } else if(colors.endsWith(userInput)){
...
//                System.out.println("your number is: " +str.length());
//            }
